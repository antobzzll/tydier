...
def str_match_ratio(str1: str, str2: str, method: str,
    ...
    if not case_sensitive: str1 = str1.lower(); str2 = str2.lower()
...
def remove_chars(obj_series: pd.Series, chars: list):
    ...
    """
    for c in chars: obj_series = obj_series.str.replace(c, '')
    return obj_series
    ...
    if mapping_dict:
        ...
        for tofix in diff:
            ...
            for cat in categories:
                ...
                cat_ls.append(cat)
                match_ratio_ls.append(str_match_ratio(tofix, cat, 'sliceeach2'))
            ...
            replacement = res.loc[res['match_ratio'] == max_ratio]['cat'].item()
